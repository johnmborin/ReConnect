                    ...
                    >
                        ...
                        >
                            <div style={{ display: 'flex' }}>
                                <span
                                    onClick={() => handleLikertClick(1)}
                                    style={{ ...likertOptionStyle, ...(score === 1 && selectedOptionStyle) }}
                                >
                                    1 Strongly Disagree
                                </span>
                                <span
                                    onClick={() => handleLikertClick(2)}
                                    style={{ ...likertOptionStyle, ...(score === 2 && selectedOptionStyle) }}
                                >
                                    2 Disagree
                                </span>
                                <span
                                    onClick={() => handleLikertClick(3)}
                                    style={{ ...likertOptionStyle, ...(score === 3 && selectedOptionStyle) }}
                                >
                                    3 Neutral
                                </span>
                                <span
                                    onClick={() => handleLikertClick(4)}
                                    style={{ ...likertOptionStyle, ...(score === 4 && selectedOptionStyle) }}
                                >
                                    4 Agree
                                </span>
                                <span
                                    onClick={() => handleLikertClick(5)}
                                    style={{ ...likertOptionStyle, ...(score === 5 && selectedOptionStyle) }}
                                >
                                    5 Strongly Agree
                                </span>
